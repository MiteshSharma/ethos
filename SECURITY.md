...
- **The tier roster** — every workspace package carries a tier in [`.architecture-state.yaml`](.architecture-state.yaml), committed and dated before any report arrives. 141 packages: 11 at Tier 0, 27 at Tier 1, 103 at Tier 2.
