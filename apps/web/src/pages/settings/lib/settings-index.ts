...
export const SETTINGS_INDEX: readonly SettingEntry[] = [
  ...
  ...group('voice', 'barge-in', [
    ...
    {
      key: 'display.voice_endpoint_silence_ms',
      formName: 'voiceEndpointSilenceMs',
      label: 'Browser — Response delay',
      dynamicGroup: 'voice-tuning',
    },
    {
      key: 'display.voice_barge_threshold',
      formName: 'voiceBargeThreshold',
      label: 'Browser — Interrupt sensitivity',
      dynamicGroup: 'voice-tuning',
    },
    {
      key: 'display.voice_barge_sustain_ms',
      formName: 'voiceBargeSustainMs',
      label: 'Browser — Interrupt hold',
      dynamicGroup: 'voice-tuning',
    },
    {
      key: 'display.voice_speech_threshold',
      formName: 'voiceSpeechThreshold',
      label: 'Browser — Mic sensitivity',
      dynamicGroup: 'voice-tuning',
    },
    {
      key: 'display.voice_speech_min_ms',
      formName: 'voiceSpeechMinMs',
      label: 'Browser — Min speech',
      dynamicGroup: 'voice-tuning',
    },
  ]),
  ...group('voice', 'trunk', [
