...
// `--text-secondary`) · control, right-aligned, with a 1px `--border-subtle`
// hairline below. Not a `Card` (DESIGN.md "Cards earn existence").
//
...
// drift apart. State-backed widgets that have no `Form.Item` (rosters, tables,
// read-only views) do not use this component; §6.3 gives them their own shape,
// in Phase 6.
//
...
import { keyForFormName } from '../lib/settings-index';
  ...
  const row = (
    <div className="settings-row">
      <div className="settings-row-info">
        ...
        {configKey ? <div className="settings-row-key">{configKey}</div> : null}
