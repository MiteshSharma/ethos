...
- **Enforced at.** [`observability-sqlite/src/store.ts:164`](https://github.com/ethosagent/ethos/blob/main/extensions/observability-sqlite/src/store.ts#L164) — the single write path, with redaction applied at `:164`, `:302`, `:355`, and `:485`.
