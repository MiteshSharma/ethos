...
- **Enforced at.** [`fs-reach.ts:136`](https://github.com/ethosagent/ethos/blob/main/packages/core/src/fs-reach.ts#L136) (`deriveFsReachPaths`, the single derivation), [`scoped-fs.ts:102`](https://github.com/ethosagent/ethos/blob/main/packages/core/src/scoped/scoped-fs.ts#L102) (`checkReach` — the deny floor, the lexical prefix test, and the segment walk) with the symlink refusal at [`:136`](https://github.com/ethosagent/ethos/blob/main/packages/core/src/scoped/scoped-fs.ts#L136), [`scoped-storage.ts:91`](https://github.com/ethosagent/ethos/blob/main/packages/storage-fs/src/scoped-storage.ts#L91), and [`path-boundary.ts:17`](https://github.com/ethosagent/ethos/blob/main/packages/core/src/path-boundary.ts#L17) (`assertWithinBase`).
...
- **Enforced at.** [`redact/index.ts:45`](https://github.com/ethosagent/ethos/blob/main/packages/safety/redact/src/index.ts#L45) (`detectSecrets`), [`:57`](https://github.com/ethosagent/ethos/blob/main/packages/safety/redact/src/index.ts#L57) (`redactString`), [`:74`](https://github.com/ethosagent/ethos/blob/main/packages/safety/redact/src/index.ts#L74) (`redactJson`), applied on the write path at [`store.ts:157`](https://github.com/ethosagent/ethos/blob/main/extensions/observability-sqlite/src/store.ts#L157), [`:295`](https://github.com/ethosagent/ethos/blob/main/extensions/observability-sqlite/src/store.ts#L295), [`:348`](https://github.com/ethosagent/ethos/blob/main/extensions/observability-sqlite/src/store.ts#L348), and [`:478`](https://github.com/ethosagent/ethos/blob/main/extensions/observability-sqlite/src/store.ts#L478); and on the approval surface at [`platform-slack/blocks/approval.ts:118`](https://github.com/ethosagent/ethos/blob/main/extensions/platform-slack/src/blocks/approval.ts#L118) and [`platform-discord/blocks/approval.ts:77`](https://github.com/ethosagent/ethos/blob/main/extensions/platform-discord/src/blocks/approval.ts#L77) (`formatArgs` in each).
...
- **Enforced at.** [`danger-predicate.ts:274`](https://github.com/ethosagent/ethos/blob/main/packages/wiring/src/danger-predicate.ts#L274), [`smart-approver.ts:144`](https://github.com/ethosagent/ethos/blob/main/packages/wiring/src/smart-approver.ts#L144) (`{ decision: 'ask', reason: 'reviewer gave no usable verdict' }`) and [`:149`](https://github.com/ethosagent/ethos/blob/main/packages/wiring/src/smart-approver.ts#L149) (`'reviewer error (fail-closed): …'`), with the union at [`danger-predicate.ts:241`](https://github.com/ethosagent/ethos/blob/main/packages/wiring/src/danger-predicate.ts#L241). The single fire site every tool call passes through is [`per-call-enforcement.ts:43`](https://github.com/ethosagent/ethos/blob/main/packages/core/src/agent-loop/stages/per-call-enforcement.ts#L43) (`enforceBeforeToolCall`, where a handler error *blocks* the call), over the sequential execution model at [`hook-registry.ts:94`](https://github.com/ethosagent/ethos/blob/main/packages/core/src/hook-registry.ts#L94) (`fireModifying`). The two seams that make the mode dispatch and `safety.denyRules` actually consulted are bound at [`approval-seams.ts:106`](https://github.com/ethosagent/ethos/blob/main/packages/wiring/src/approval-seams.ts#L106), and the posture guard that refuses an unbacked `gated` claim is [`approval-posture.ts:38`](https://github.com/ethosagent/ethos/blob/main/packages/core/src/agent-loop/approval-posture.ts#L38).
...
- **Enforced at.** [`resolve-execution-posture.ts:234`](https://github.com/ethosagent/ethos/blob/main/packages/wiring/src/resolve-execution-posture.ts#L234) (`resolveExecutionPosture`, the posture selection), with the build-impossible branch at [`:289`](https://github.com/ethosagent/ethos/blob/main/packages/wiring/src/resolve-execution-posture.ts#L289), the `hostFallback` labelling at [`:329`](https://github.com/ethosagent/ethos/blob/main/packages/wiring/src/resolve-execution-posture.ts#L329), and the daemon-unavailable decision at [`:406`](https://github.com/ethosagent/ethos/blob/main/packages/wiring/src/resolve-execution-posture.ts#L406).
...
- **Enforced at.** [`observability-sqlite/src/store.ts:157`](https://github.com/ethosagent/ethos/blob/main/extensions/observability-sqlite/src/store.ts#L157) — the single write path, with redaction applied at `:157`, `:295`, `:348`, and `:478`.
