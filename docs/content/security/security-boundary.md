...
- **Enforced at.** [`fs-reach.ts:136`](https://github.com/ethosagent/ethos/blob/main/packages/core/src/fs-reach.ts#L136) (`deriveFsReachPaths`, the single derivation), [`scoped-fs.ts:102`](https://github.com/ethosagent/ethos/blob/main/packages/core/src/scoped/scoped-fs.ts#L102) (`checkReach` — the deny floor, the lexical prefix test, and the segment walk) with the symlink refusal at [`:136`](https://github.com/ethosagent/ethos/blob/main/packages/core/src/scoped/scoped-fs.ts#L136), [`scoped-storage.ts:79`](https://github.com/ethosagent/ethos/blob/main/packages/storage-fs/src/scoped-storage.ts#L79), and [`path-boundary.ts:17`](https://github.com/ethosagent/ethos/blob/main/packages/core/src/path-boundary.ts#L17) (`assertWithinBase`).
